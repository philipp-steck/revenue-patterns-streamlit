...
def plot_1(df_aggregate_payments):
    ...
    you_vs_industry = correlation_matrix.loc["D3", "D60"]
    st.divider()
    st.write("")

    fig, ax = plt.subplots(figsize=(10, 8))
    sns.heatmap(
        reversed_corr_matrix,
        annot=True,
    ...
    with col2:
        ...
        st.markdown(
            """<div style="text-align: left;">
             Correlation score between day 3 and day 60.      
        </div>""",
    ...
    and their relative importance by day 60 by knowing the valuable customers on day 3. 
